...
cap log close
cap log using "${directory_results}/table_a10a`1'", replace
...
cap log close
cap log using "${directory_results}/table_a10b`1'", replace
...
cap log close
cap log using "${directory_results}/table_a10c`1'", replace
