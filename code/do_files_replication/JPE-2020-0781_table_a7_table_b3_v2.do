******************************************************
*PROPENSITY SCORE MATCHING BETWEEN TREATED AND CONTROL
******************************************************
**Panel A
...
reghdfe `dep_var' ${pre_post} if balanced==1 & second_treatment=="", absorb(app_window app_day county_sector_time) cluster(cluster)
...
outreg2 using "${directory_results}/table_a7.xls", dec(3) addstat(Mean dep var, `mean3', SD dep var, `sd3')  addtext(Sector FE, NO, App Window FE, YES, App date FE, YES, County FE, NO, Subd FE, NO, TWI FE, NO, County-Sector FE, YES, TWI-Sector FE, NO, Sub-sector FE, NO, Firm FE, NO, Cluster, Sub-App, Balanced, YES) keep(${keep_pre_post}) `command'
...
*outreg2 using "${directory_results}/table_b3.xls", dec(4) replace
...
reghdfe `dep_var' ${pre_post} if balanced==1 & second_treatment=="" & matched==1, absorb(app_window app_day county_sector_time) cluster(cluster)
...
outreg2 using "${directory_results}/table_a7.xls", dec(3) addstat(Mean dep var, `mean3', SD dep var, `sd3')  addtext(Sector FE, NO, App Window FE, YES, App date FE, YES, County FE, NO, Subd FE, NO, TWI FE, NO, County-Sector FE, YES, TWI-Sector FE, NO, Sub-sector FE, NO, Firm FE, NO, Cluster, Sub-App, Balanced, YES) keep(${keep_pre_post}) append
