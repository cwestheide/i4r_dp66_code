...
foreach 1 in "" 3 5 {
	...
	***Panels A and D: Sales and TFP, alternative fixed effects
	...
	use "${directory_data}/app_main_outcomes_yearly_v2.dta", clear
	...
	*Yearly effects
	...
	reghdfe `dep_var' ${year_effects} if balanced==1 & second_treatment=="" & keep_obs==1, `conditions' cluster(cluster)
	preserve
	regsave, ci
	...
	*Labels of the y variables
	...
	graph export "${directory_results}/figureA5_`dep_var'_main_specs_v2.pdf", replace
	...
	*Labels of the y variables
	...
	graph export "${directory_results}/figureA5_`dep_var'_clustering`1'_v2.eps", replace
